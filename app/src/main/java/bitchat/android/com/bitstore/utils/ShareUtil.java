...
public class ShareUtil {
    ...
    public static void share(Context context, String extraText) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, context.getString(R.string.str_action_share));
        intent.putExtra(Intent.EXTRA_TEXT, extraText);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(Intent.createChooser(intent, context.getString(R.string.str_action_share)));
    }
}
