...
public class Configuration {
    ...
    public static final int PREFS_DEFAULT_BTC_SHIFT = 0;
    public static final int PREFS_DEFAULT_BTC_PRECISION = 4;
...
//        return Strings.emptyToNull(prefs.getString(PREFS_KEY_TRUSTED_PEER,Constants.TEST? TestNet3Params.ID_TESTNET: MainNetParams.ID_MAINNET).trim());
//    }
